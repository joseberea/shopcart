...
class CartProductsControllerTest < ActionController::TestCase
  ...
  test "should create cart_product" do
    assert_difference('CartProduct.count') do
      post :create, cart_product: { cart_id: @cart_product.cart_id, product_id: @cart_product.product_id, quantity: @cart_product.quantity }
    end
  ...
  test "should update cart_product" do
    patch :update, id: @cart_product, cart_product: { cart_id: @cart_product.cart_id, product_id: @cart_product.product_id, quantity: @cart_product.quantity }
    assert_redirected_to cart_product_path(assigns(:cart_product))
  end
